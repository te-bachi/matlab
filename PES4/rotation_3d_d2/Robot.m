...
%             T_2_3 = Transformation(obj.A2(1:3,2), 0,      0, 0);
            ...
            if 0
                ...
                T_0_1 = Transformation([    0; 0; 0], deg2rad(obj.q1_x_degree), deg2rad(obj.q1_y_degree), deg2rad(obj.q1_z_degree));
                T_1_2 = Transformation([    0; 0; 0], deg2rad(obj.q2_x_degree), deg2rad(obj.q2_y_degree), deg2rad(obj.q2_z_degree));
                T_2_3 = Transformation([    0; 0; 0], deg2rad(obj.q2_x_degree), deg2rad(obj.q2_y_degree), deg2rad(obj.q2_z_degree));
            ...
            tmp_Q1 = tform2quat(T01)
            tmp_Q2 = tform2quat(T02)
            tmp_Q3 = tform2quat(T03)
